...
**REQ-DISP-100:** The display node shall support LEDs directly driven via a GPIO.<br/>
...
**REQ-DISP-110:** The display node shall support LEDs driven by shift register (74HC595) for larger LED counts.<br/>
...
**REQ-DISP-120:** The display node shall support LED matrix displays driven by MAX7219 via SPI.<br/>
...
**REQ-DISP-130:** The display node shall support 7 (or 8) segment LEDs driven without a driver IC.<br/>
...
**REQ-DISP-140:** The display node shall support seven (or 8) segment displays driven by a TM1637 driver ic.<br/>
**Rationale:** Typical way of driving seven segment displays.<br/>
**Alternatives considered:** -

**REQ-DISP-150:** The display node shall support LEDs driven by a TM1637 or TM1638 via a 4-wire serial interface.<br/>
...
**REQ-DISP-160:** The display node shall support LCD character displays driven by PCF8574 via I2C.<br/>
**Rationale:** Provides a common and widely available display option with minimal GPIO usage.<br/>
**Alternative considered:** Using GPIOs for LCD control — rejected, would exhaust available GPIO pins and be impractical.<br/>

**REQ-DISP-170:** The display node shall support OLED displays driven by SSD1306 via I2C.<br/>
...
**REQ-DISP-200:** The display node shall support PWM for LED controlling.<br/>
