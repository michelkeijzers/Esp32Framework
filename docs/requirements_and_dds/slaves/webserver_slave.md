...
**REQ-WEB-250:** The webserver slave shall attempt router connection (STA mode) at boot and fall back to own AP (192.168.4.1) if no router is available.<br/>
...
**REQ-WEB-650:** OTA updates shall only be available on the webserver slave when connected to a router in STA mode.<br/>
...
**REQ-WEB-750:** Webserver slave losing Wi-Fi shall not affect ESP-NOW routing — master and slaves continue operating normally.
