...
**REQ-SLV-310:** All slaves shall report their firmware version to master via ESP-NOW at boot.<br/>
...
**REQ-SLV-700:** Slaves shall support a debug mode sending debug data via Master to Webserver to Website.<br/>
...
## Slave Offline Behavior

**REQ-SLV-750:** Slave offline behavior during performance shall be defined per slave type — system shall degrade gracefully.<br/>
...
**REQ-SLV-9500:** ESP-NOW simultaneous transmission from multiple slaves shall be handled gracefully — the protocol handles collision at RF level, software queuing handles ordering.
